...
urlpatterns = patterns(
    ...
    url(r'^(?P<service_pk>\d+)/edit/$', views.service_update, {},
    ...
    url((r'^service/(?P<service_pk>\d+)/remove/'  r'(?P<pk>\d+)/$'),
        views.remove_song, {},
        'kanisa_members_services_remove_song'),
    url((r'^service/(?P<service_pk>\d+)/move/'  r'(?P<song_pk>\d+)/down/$'),
        views.move_down, {},
        'kanisa_members_services_move_song_down'),
    url((r'^service/(?P<service_pk>\d+)/move/'  r'(?P<song_pk>\d+)/up/$'),
        views.move_up, {},
