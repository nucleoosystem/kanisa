...
urlpatterns = patterns('',
    ...
    url(r'^manage/diary/scheduled/create/$',
        staff_member_required(DiaryScheduledEventCreateView.as_view()),
    ...
    url(r'^manage/diary/schedule/all/$',
        staff_member_required(DiaryScheduleWeeksRegularEventView.as_view()),
