...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScheduledEvent.duration'
        db.alter_column('kanisa_scheduledevent', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ScheduledEvent.duration'
        db.alter_column('kanisa_scheduledevent', 'duration', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'kanisa.scheduledevent': {
            ...
            'details': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'duration': ('django.db.models.fields.IntegerField', [], {'default': '60', 'null': 'True', 'blank': 'True'}),
