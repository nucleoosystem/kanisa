...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Service', fields ['event']
        db.create_unique('kanisa_service', ['event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Service', fields ['event']
        db.delete_unique('kanisa_service', ['event_id'])
