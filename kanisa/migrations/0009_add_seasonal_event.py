...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeasonalEvent'
        db.create_table(u'kanisa_seasonalevent', (
        ...
        db.send_create_signal('kanisa', ['SeasonalEvent'])


    def backwards(self, orm):
        # Deleting model 'SeasonalEvent'
        db.delete_table(u'kanisa_seasonalevent')
    ...
    models = {
        ...
        'kanisa.seasonalevent': {
            'Meta': {'object_name': 'SeasonalEvent'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'duration': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
