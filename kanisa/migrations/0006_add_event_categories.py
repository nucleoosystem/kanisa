...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('kanisa_eventcategory', (
        ...
        db.create_table('kanisa_regularevent_categories', (
        ...
        db.create_unique('kanisa_regularevent_categories', ['regularevent_id', 'eventcategory_id'])


    def backwards(self, orm):
        # Deleting model 'EventCategory'
        db.delete_table('kanisa_eventcategory')

        # Removing M2M table for field categories on 'RegularEvent'
        db.delete_table('kanisa_regularevent_categories')
