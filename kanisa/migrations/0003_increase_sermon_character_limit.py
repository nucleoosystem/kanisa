...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sermon.title'
        db.alter_column(u'kanisa_sermon', 'title', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'SermonSeries.title'
        db.alter_column(u'kanisa_sermonseries', 'title', self.gf('django.db.models.fields.CharField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'Sermon.title'
        db.alter_column(u'kanisa_sermon', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'SermonSeries.title'
        db.alter_column(u'kanisa_sermonseries', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))
