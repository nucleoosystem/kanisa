...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledEvent.end_date'
        db.add_column('kanisa_scheduledevent', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledEvent.end_date'
        db.delete_column('kanisa_scheduledevent', 'end_date')
