...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Banner.order'
        db.add_column('kanisa_banner', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Banner.order'
        db.delete_column('kanisa_banner', 'order')


    models = {
        'kanisa.banner': {
            'Meta': {'ordering': "('publish_from', '-publish_until')", 'object_name': 'Banner'},
