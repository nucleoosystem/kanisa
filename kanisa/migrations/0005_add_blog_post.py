...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'kanisa_blogpost', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kanisa.RegisteredUser'])),
            ...
            ('teaser_text', self.gf('django.db.models.fields.TextField')()),
            ('main_text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('kanisa', ['BlogPost'])


    def backwards(self, orm):
        # Deleting model 'BlogPost'
        db.delete_table(u'kanisa_blogpost')
    ...
    models = {
        ...
        'kanisa.blogpost': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kanisa.RegisteredUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
