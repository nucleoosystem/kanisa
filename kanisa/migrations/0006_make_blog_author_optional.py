...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'kanisa_blogpost', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kanisa.RegisteredUser'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BlogPost.author'
        raise RuntimeError("Cannot reverse this migration. 'BlogPost.author' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BlogPost.author'
        db.alter_column(u'kanisa_blogpost', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kanisa.RegisteredUser']))
