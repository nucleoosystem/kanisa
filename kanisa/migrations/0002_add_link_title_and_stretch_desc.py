...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NavigationElement.alternate_title'
        db.add_column(u'kanisa_navigationelement', 'alternate_title',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'NavigationElement.description'
        db.alter_column(u'kanisa_navigationelement', 'description', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting field 'NavigationElement.alternate_title'
        db.delete_column(u'kanisa_navigationelement', 'alternate_title')


        # Changing field 'NavigationElement.description'
        db.alter_column(u'kanisa_navigationelement', 'description', self.gf('django.db.models.fields.CharField')(max_length=30))
