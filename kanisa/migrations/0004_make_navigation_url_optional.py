...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NavigationElement.url'
        db.alter_column(u'kanisa_navigationelement', 'url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'NavigationElement.url'
        db.alter_column(u'kanisa_navigationelement', 'url', self.gf('django.db.models.fields.CharField')(default='/', max_length=200))
