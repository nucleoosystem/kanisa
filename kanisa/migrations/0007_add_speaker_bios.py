...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SermonSpeaker.biography'
        db.add_column(u'kanisa_sermonspeaker', 'biography',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SermonSpeaker.biography'
        db.delete_column(u'kanisa_sermonspeaker', 'biography')
