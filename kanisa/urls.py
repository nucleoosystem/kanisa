...
urlpatterns = patterns('',
    ...
    url(r'^manage/diary/regular/create/$',
        staff_member_required(DiaryRegularEventCreateView.as_view()),
        {}, 'kanisa_manage_diary_regular_create'),
    url(r'^manage/diary/regular/edit/(?P<pk>\d+)$',
        staff_member_required(DiaryRegularEventUpdateView.as_view()),
        {}, 'kanisa_manage_diary_regular_update'),
    url(r'^manage/diary/scheduled/edit/(?P<pk>\d+)$',
        staff_member_required(DiaryScheduledEventUpdateView.as_view()),
